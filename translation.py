...
HELP_MESSAGE = '''**Hello, {}
I Am Oggylink, Bulk Link Converter Bot. I Can Convert Links Directly From Your Oggylink Account,**
...
ABOUT_TEXT = '''**Hey! My name is @Oggylink_bulk_Short_Bot. I am Oggylink Fly Link Converter Bot.**
...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of Oggylink than **contact** at 👉 @Sohan_Rajpurohit_1 (all **shortners support** available.)
...
Ex: https://t.me/@Oggylink_bulk_Short_Bot | Oggylink"""
...
**- Message @Sohan_Rajpurohut_1 For More Help -**"""
